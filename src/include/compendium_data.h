...
const char* COMPENDIUM_DATA[] = {
	...
	// Dark
	"Noctara", 			"Dark Princess",	"107",		"She/Any",			"Not much is known about Noctara Velestra, other than she was once a powerful Evil witch that ruled from the shadows. After an intense battle with Amara, she realized the error of her ways, and decided to renounce her Evilness. With her change of heart, she still brings much knowledge of ancient and dark magics. Plus, she knows exactly how to push the Evil's buttons.",
	// Desert
	...
	"Evil Ed",			"Ruler of the Evil","???",		"Gets angry when you say the word 'pronoun'.", "Let's face it, Evil Ed is a plain meanie. Always in a state of anger, he orchestrated the very attack that the princesses sought to stop. I mean, he refuses all invitations to the Super Graphic Ultra Modern Princess Ball, who does that?? Ahem... pardon me. Let's just say, Ol' Eddie is not a force to be reckoned with. Unless, of course, you're a gang of ultra-queer, ultra-powerfull princesses."
};
#endif
